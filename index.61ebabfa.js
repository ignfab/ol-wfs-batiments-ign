 ...
 */class extends n5{/**
   ...
   */getMatrixIds(){return this.matrixIds_}}({origin:[-20037508,20037508],resolutions:oi,matrixIds:on}),oa=new rg({format:new rL,url:function(t){return"https://wxs.ign.fr/essentiels/geoportail/wfs?service=WFS&version=1.1.0&request=GetFeature&typename=BDTOPO_V3:batiment&outputFormat=application/json&srsname=EPSG:3857&bbox="+t.join(",")+",EPSG:3857"},strategy:/**
     ...
     */function(t,e,i){var n;let r=oo.getZForResolution(e),s=oo.getTileRangeForExtentAndZ(t,r),o=[],a=[r,0,0];for(a[1]=s.minX;a[1]<=s.maxX;++a[1])for(a[2]=s.minY;a[2]<=s.maxY;++a[2])o.push(n=oo.getTileCoordExtent(a));return o}}),ol=new s5({source:oa,style:new rU({stroke:new rG({color:"rgba(0, 0, 255, 1.0)",width:2}),fill:new rk({color:"rgba(0, 0, 255, 0.2)"})})}),oh=new ro({url:"https://wxs.ign.fr/essentiels/geoportail/wmts",//layer: 'GEOGRAPHICALGRIDSYSTEMS.PLANIGNV2',
//format: 'image/png'
layer:"ORTHOIMAGERY.ORTHOPHOTOS",format:"image/jpeg",matrixSet:"PM",projection:"EPSG:3857",tileGrid:oo,style:"normal",attributions:'<a href="http://www.ign.fr" target="_blank"><img src="https://wxs.ign.fr/static/logos/IGN/IGN.gif" title="Institut national de l\'information g\xe9ographique et foresti\xe8re" alt="IGN"></a>'}),ou=new nK({source:oh}),od=new nw({layers:[ou,ol],overlays:[oe],target:document.getElementById("map"),view:new ii({center:(er(),ef([3.280578,47.368489],"EPSG:4326",void 0!==s?s:"EPSG:3857")),minZoom:16,maxZoom:20,zoom:19})});// Ouverture infobulle
od.on("singleclick",function(t){var e=t.coordinate,i=od.forEachFeatureAtPixel(t.pixel,function(t,e){return t});if(i){var n=i.getProperties(),s="<center><b>"+i.getId().replace("batiment.","")+"</b></center>";for(let t in s+="<ul>",n)if(null!=n[t]&&""!=n[t]&&ot.includes(t)){var o=n[t];if("materiaux_des_murs"==t&&(o=/*@__PURE__*/r(s4)[n[t]]),"materiaux_de_la_toiture"==t&&(o=/*@__PURE__*/r(s6)[n[t]]),"INDETERMINE"==o||!1==o)continue;s+="<li><b>"+t+"</b> : "+o+"</li>"}s+="</ul>",s8.innerHTML=s,oe.setPosition(e)}});//# sourceMappingURL=index.61ebabfa.js.map

//# sourceMappingURL=index.61ebabfa.js.map
